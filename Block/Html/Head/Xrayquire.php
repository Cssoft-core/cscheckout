...
namespace CSSoft\Cscheckout\Block\Html\Head;
...
{
    const XRAYQUIRE_PATH         = 'CSSoft_Cscheckout::js/lib/xrayquire.js';

    const XRAYQUIRE_MAGENTO_PATH = 'CSSoft_Cscheckout::js/lib/xrayquire-magento.js';
