...
class CscheckoutConfigProvider
{
    /**
    ...
    public function afterGetConfig(
        ...
        if ($this->helper->isOnCscheckoutPage()) {
            ...
            $result['checkoutUrl'] = $this->helper->getCscheckoutUrl();

            if (isset($result['validatedEmailValue']) &&
                $result['validatedEmailValue'] === 'mail@example.com'
            ) {
                $result['validatedEmailValue'] = '';
            }
        }
        return $result;
    }
