...
class AdditionalContent extends \Magento\Framework\App\Helper\AbstractHelper
{
     ...
     * @var string
     */
    const CONFIG_PATH_CMS_BLOCK_TOP = 'cscheckout/additional_content/top';

    /**
     * @var string
     */
    const CONFIG_PATH_CMS_BLOCK_BOTTOM = 'cscheckout/additional_content/bottom';

    /**
     * @var string
     */
    const CONFIG_PATH_CMS_BLOCK_BELOW_ORDER_SUMMARY = 'cscheckout/additional_content/below_order_summary';

    /**
     * @var string
     */
    const CONFIG_PATH_CMS_BLOCK_BELOW_PLACE_ORDER = 'cscheckout/additional_content/below_place_order';

    /**
     * @var string
     */
    const CONFIG_PATH_CMS_BLOCK_INTRO_POPUP_GUEST = 'cscheckout/additional_content/intro/guest';

    /**
     * @var string
     */
    const CONFIG_PATH_CMS_BLOCK_INTRO_POPUP_REGISTERED = 'cscheckout/additional_content/intro/registered';
    ...
    {
        return 'CSSoft_Cscheckout::additional_content.phtml';
    }
    ...
    {
        if ($this->session->getCscheckoutIntroPopupFlag()) {
            return false;
        }
        ...
        if ($id) {
            $this->session->setCscheckoutIntroPopupFlag(true);
        }
